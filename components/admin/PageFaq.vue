          ...
          <tbody>
            ...
            <tr v-for="(f, index) in items" :key="f.id">
              ...
              <td>
                ...
                <div class="cell-secondary">{{ f.answer?.slice(0, 50) }}...</div>
              </td>
              <td><span class="tag">{{ f.category }}</span></td>
              <td class="cell-secondary">{{ f.sort_order }}</td>
              <td>
                <span :class="['badge', f.status === 'published' ? 'badge-green' : 'badge-amber']">
              ...
              <td>
                <div class="action-group">
                  ...
                  <button class="btn-icon btn-icon-danger" @click="emit('delete', f.id)">
