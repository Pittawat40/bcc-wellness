    ...
    <div class="page-header">
      <div>
        ...
        <p class="page-subtitle">
          จัดการเรื่องราวความสำเร็จของลูกค้า ({{ items.length }} รายการ)
        </p>
      </div>
        ...
        <table>
          ...
          <tbody>
            ...
            <tr v-for="(s, index) in items" :key="s.id">
              ...
              <td>
                <div class="cell-primary">{{ s.title }}</div>
                <div class="cell-secondary">{{ s.author }}</div>
              </td>
              <td>
                <span
              ...
              <td>
                <div class="action-group">
                  <button class="btn-icon" @click="openModal(s)" title="แก้ไข">
