                ...
                <div v-for="cat in categories" :key="cat.id" class="cat-row">
                  ...
                  <template v-else>
                    <div class="cat-name">
                      ...
                      <span v-if="cat.slug" class="cat-slug">{{ cat.slug }}</span>
                    </div>
...
function startEdit(cat: any) {
  editingId.value = cat.id; editTh.value = cat.name_th; editEn.value = cat.name_en || "";
}
...
.cat-close { background: none; border: none; cursor: pointer; color: #6b7280; font-size: 1rem; padding: 4px; border-radius: 6px; display: flex; align-items: center; justify-content: center; transition: background 0.15s; }
...
.cat-slug { font-size: 0.7rem; color: #9ca3af; font-family: monospace; }
