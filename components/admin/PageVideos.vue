  ...
  <div>
    <div class="page-header-videos">
      ...
      <div class="header-actions">
        <button class="btn-add-video" @click="emit('add')">
          ...
          <table>
            ...
            <tbody>
              ...
              <tr v-for="(v, index) in items" :key="v.id">
                ...
                <td>
                  <div class="cell-primary line-clamp-1">{{ v.title }}</div>
                </td>
                <td>
          ...
          >
            ...
            <div class="mobile-card-body">
              <div class="mobile-info-text">
                <div class="cell-primary line-clamp-1">{{ v.title }}</div>
                <div class="mobile-url-box mt-2">
                  <i class="bi bi-link-45deg"></i>
                  <a
                    :href="v.url"
                    target="_blank"
                    rel="noopener noreferrer"
                    class="mobile-url-link"
                  >
                    {{ v.url }}
                  </a>
                </div>
