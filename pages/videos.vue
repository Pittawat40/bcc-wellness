      ...
      <div class="container-wide">
        <div class="mb-8 md:mb-10 border-l-4 border-brand-600 pl-4">
          <h2 class="font-serif text-2xl font-bold text-neutral-900 mb-1">
            {{
              lang === "th"
                ? "วิดีโอเรื่องราวและความรู้ทั้งหมด"
                : "All Videos & Inspirational Stories"
            }}
          </h2>
          <p class="text-sm md:text-base text-neutral-500">
            {{
              lang === "th"
                ? "รับชมสาระน่ารู้และประสบการณ์ตรงจากเรา"
                : "Watch educational insights and real patient journey experiences."
            }}
          </p>
        </div>
        <!-- Loading -->
        ...
        <div
          ...
          class="text-center py-20 text-neutral-400 text-sm"
        >
          {{
            lang === "th"
